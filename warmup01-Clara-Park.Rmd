...
Approved In | 54 episodes
Titles | Lady of WinterfelL    princess    Lady Regent of the North
Also known as | Little dove    Little bird    Sansa Lannister    Sansa Bolton    Alayne    Lady Stark    Lady Bolton
Status | Alive
Age | 19 in Season 7
Date of Birth | 285 AC
Origin | Winterfell
Allegiance | House Stark (by birth)    House Bolton (formerly; by marriage)    House Lannister (formerly; by marriage)
Predecessor | Ramsay Bolton (Lord of Winterfell)
Culture | Northmen    Andal
Religion |Old Gods of the Forest    Faith of the Seven
Father | {Eddard Stark}
Mother | {Catelyn Stark}
Spouse | Tyrion Lannister (1st husband; unconsummated)    {Ramsay Bolton} (2nd husband)
Siblings | {Robb Stark}    Arya Stark    Bran Stark    {Rickon Stark}    Jon Snow (paternal cousin raised as bastard half-brother)
...
$a*^2 + b*x + c = 0$,    
$4*^2*x^2 + 4*a*b*x + 4*a*c = 0$,    
$4*a^2*x^2 + 4*a*b*x = -4*a*c$,    
$4*a^*x^ + 4*a*b*x _ b^2 = b^2 - 4*a*c$,    
$(2*a*x + b)^2 = b^2 - 4*a*c$,    
